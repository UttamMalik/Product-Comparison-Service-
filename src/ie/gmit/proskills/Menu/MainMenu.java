...
public class MainMenu extends JFrame {
	...
	public MainMenu(int x, int y) {
		...
		String headerHistory[] = new String[] { "Item Name", "Ebay AVG", "Amazon AVG", "Flipkart AVG", "Date" };
		...
		JLabel lblAmazonAVG = new JLabel("AMAZON AVG:");
		lblAmazonAVG.setForeground(Color.LIGHT_GRAY);
		lblAmazonAVG.setBounds(162, 466, 89, 14);
		contentPane.add(lblAmazonAVG);
		...
		TextArea taAmazonAVG = new TextArea("INR0.00", 3, 100, TextArea.SCROLLBARS_NONE);
		taAmazonAVG.setBounds(257, 465, 70, 20);
		contentPane.add(taAmazonAVG);
		...
		TextArea taFlipkartAVG = new TextArea("INR0.00", 3, 100, TextArea.SCROLLBARS_NONE);
		taFlipkartAVG.setBounds(426, 465, 70, 20);
		contentPane.add(taFlipkartAVG);
		...
		JCheckBox chckbxNewegg = new JCheckBox("Flipkart");
		...
		// Radio box for querying the DoneDeal store
		JCheckBox chckbxDonedeal = new JCheckBox("Amazon");
		...
		JLabel lblFlipkartAVG = new JLabel("Flipkart AVG:");
		lblFlipkartAVG.setForeground(Color.LIGHT_GRAY);
		lblFlipkartAVG.setBounds(331, 466, 89, 14);
		contentPane.add(lblFlipkartAVG);
		...
		btnStore_Search.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (tfStore_Seach.getText().isEmpty()) {
					...
					taAmazonAVG.setText("INR" + StoreInfo.getDoneDealAVG());
					
					taFlipkartAVG.setText("INR" + StoreInfo.getNeweggAVG());
					...
					dtmHistory.addRow(new Object[] { itemSearch,
							...
							"INR" + df.format(Double.parseDouble(StoreInfo.getDoneDealAVG())),
							"INR" + df.format(Double.parseDouble(StoreInfo.getNeweggAVG())),
							dateFormat.format(date) });
